  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo base_url('') ?>" class="brand-link">
      <img src="<?php echo base_url('assets/adminlte') ?>/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">JEPARADISE</span>
    </a>
    ...
    <div class="sidebar">
	  ...
	  <?php
		...
		$segmentp = $this->uri->segment('1');
		// echo $buku;
		$buku = '';
		$dashboard = '';
		$pengguna = '';
		if($segment == 'buku/arsip'){
			$buku = 'active';
		}else if($segmentp == 'pengguna'){
			$pengguna = 'active';
		}else if($segment == 'admin/dashboard'){
			$dashboard ='active';
		}
	  ?>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url() .'buku/arsip'; ?>" class="nav-link <?php echo $buku;?>">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url() .'pengguna'; ?>" class="nav-link <?php echo $pengguna;?>">
